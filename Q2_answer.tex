...
% a system diagram describing the full system and data flow from sensor
% device to analytics application.
% B) Discuss the role of analytics, including machine learning and forecasting, in
% your design. You should include the type of data to be processed and the
% location of data analytics within your system.
% i. Which decisions or ratings do you assume to be of interest, based on
% your data analytics?
